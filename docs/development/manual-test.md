...
1. Install `vscode-extension/hnnx-<version>.vsix`.
2. Reload VS Code.
...
1. Mark `dist/HNNX-<version>-x64.AppImage` executable and launch it.
2. Install `dist/HNNX-<version>-x64.deb` on a Debian/Ubuntu test machine.
