...
## macOS에서 앱이 손상되었거나 확인할 수 없다고 표시합니다
...
## `externally-managed-environment` 오류가 발생합니다
...
## HNNX가 ONNX GraphSurgeon을 찾지 못합니다
...
## VSIX가 local에서는 동작하지만 Remote 또는 Kubernetes에서 동작하지 않습니다
...
## Encodings를 불러왔지만 일부 tensor가 일치하지 않습니다
...
## External-data ONNX를 열거나 저장할 수 없습니다
...
## Save As는 성공했지만 원본 파일이 바뀌지 않습니다
